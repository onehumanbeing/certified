...
const CertificateTemplate: React.FC<CertificateTemplateProps> = ({
    ...
    const materialsText = materials ? materials.replace(/\\n/g, "<br>") : ""
        ...
        <div className="certificate-template">
            <div className="certificate-template-left">
                ...
                <div className="details">
                    ...
                    <div className="detail">
                        ...
                        <span>
                            ...
                            <span className="deepen-text">{artworkTitle}</span>, is an original
                            work created by <span className="deepen-text">{artistName}</span>. This
                ...
                <div className="signature">
                    ...
                    <img src={signatureImagePath} alt="Signature" className="signature-image" />
                </div>
                <p className="url-text">{certificateUrl}</p>
                <img className="left_shading" src="https://sdk-static.thecertified.xyz/Down.svg" />
            </div>
            <div className="certificate-template-right">
                ...
                <img className="right_shading" src="https://sdk-static.thecertified.xyz/UP.svg" />
            </div>
        </div>
    )
}
